...
# Initialize a PHP project with Composer for Symfony
set -e
...
if [ ! -f "composer.json" ]; then
    echo "Initializing a new Symfony project..."
    # Utilise le squelette de base (symfony/skeleton) pour un projet minimaliste
...
echo "Symfony project setup complete in $PROJECT_DIR."
exit 0